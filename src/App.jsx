        ...
        <>
          ...
          <main className="main-content" style={{ background: appTheme.bg, position: 'relative' }}>
            <AnimatePresence mode="wait">
              ...
              {activeTab === 'report' && <motion.div key="r" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}><SolutionView onBack={() => setActiveTab('settings')} userRole={userRole} husbandInfo={husbandInfo} wifeInfo={wifeInfo} schedules={schedules} /></motion.div>}
